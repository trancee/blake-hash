...
struct BLAKE2bEmptyTests {
    ...
    @Test func blake2b512Empty() {
        let result = BLAKE2b.hash(Data(), digestLength: 64)
...
struct BLAKE2bAbcTests {
    ...
    @Test func blake2b512Abc() {
        let result = BLAKE2b.hash(Data(abc), digestLength: 64)
...
struct BLAKE2bSequentialTests {
    @Test func sequential64() {
        let result = BLAKE2b.hash(Data(sequentialBytes(64)), digestLength: 64)
    ...
    @Test func sequential128() {
        let result = BLAKE2b.hash(Data(sequentialBytes(128)), digestLength: 64)
    ...
    @Test func sequential256() {
        let result = BLAKE2b.hash(Data(sequentialBytes(256)), digestLength: 64)
...
struct BLAKE2bKeyedTests {
    ...
    @Test func keyedEmpty() {
        let result = BLAKE2b.hash(Data(), digestLength: 64, key: Data(key))
    ...
    @Test func keyedAbc() {
        let result = BLAKE2b.hash(Data("abc".utf8), digestLength: 64, key: Data(key))
...
struct BLAKE2bStreamingTests {
    @Test func streamingMatchesOneShot() {
        ...
        let oneShot = BLAKE2b.hash(Data(input), digestLength: 64)
