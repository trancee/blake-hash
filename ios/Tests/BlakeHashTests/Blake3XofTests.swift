...
struct Blake3XofTests {
    ...
    func prefixProperty() {
        ...
        #expect(Array(out128.prefix(64)) == out64)
        #expect(Array(out128.prefix(32)) == out32)
        #expect(Array(out64.prefix(32)) == out32)
    }
    ...
    func keyedXofEmpty32() {
        var hasher = Blake3.Hasher(key: Blake3XofTests.key)
        hasher.update([])
        let out = hasher.finalizeXof(outputLength: 32)
